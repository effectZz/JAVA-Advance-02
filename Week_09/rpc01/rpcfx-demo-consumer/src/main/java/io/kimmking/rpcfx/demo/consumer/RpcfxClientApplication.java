...
public class RpcfxClientApplication {
	...
	public static void main(String[] args) {
		...
		UserService userService0 = Rpcfx.create(UserService.class, "http://localhost:8080/");
		User user0 = userService0.findById(1);
		System.out.println("find user id=1 from server: " + user0.getName());

		UserService userService = Rpcfx.create0(UserService.class, "http://localhost:8080/");
